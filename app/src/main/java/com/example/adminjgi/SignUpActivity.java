...
public class SignUpActivity extends AppCompatActivity {
    ...
    private EditText email,key,rkey,mobile,id,myname,pass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myname=(EditText)findViewById(R.id.ed5);
        id=(EditText)findViewById(R.id.ed6);
    ...
    private void registeruser()
    {
      final   String username=email.getText().toString().trim();
        ...
        final String idno=id.getText().toString().trim();
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            note.put(Key_id,idno);
                            note.put(Key_name,name);
                            note.put(Key_passcode,passcode);
